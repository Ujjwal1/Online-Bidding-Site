...
<body>
	<div id="bgextend">
		...
		?>
			...
			<?php if ($isAdmin) { ?><div class="navbar2"> <a href="http://topherball.com/uploadResult.php">Upload Result </a> | <a href="http://topherball.com/defaultPick.php"> Set Default Pick</a> | <a href="send_email.php">Send Email</a> | <a href="users.php">Update Users</a> | <a href="http://topherball.com/setpoint.php"> Current Pool Pot Amount </a> | <a href="email_templates.php">Email Templates</a> | <a href="lockMatch.php">Lock the Match</a> | <a href="http://topherball.com/reactivateUser.php">Reactivate User</a> | <a href="http://topherball.com/verify_user.php">Verify User</a> </div><?php } ?>
		<?php
		}
