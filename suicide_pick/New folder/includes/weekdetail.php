<?php
	...
	$start_date=1; 		// Write 1,2,3...9 not like 01,02,03,..09 other-wise it will give erroneous result
	...
	//$curr_week_by_calendar = date("W");			// Remove the comment tag from the and add it to the next line.
	$curr_week_by_calendar =44;
